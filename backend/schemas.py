...
class SiteCreate(BaseModel):
    ...
    lat: float
    lon: float
    # Assigns the site manager to the site being created, this is optional as the site can be created without a manager and assigned later
...
class SiteResponse(BaseModel):
    ...
    manager_id: Optional[int] = None # Added to match models.py
